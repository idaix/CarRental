...
from . import views
from.views import MakeCreateView, MakeDeleteView, MakeUpdateView,ModelCreateView, ModelDeleteView, ModelUpdateView,EnergyCreateView,EnergyDeleteView,EnergyUpdateView,OptionCreateView,OptionDeleteView,OptionUpdateView,TransmissionCreateView,TransmissionDeleteView,TransmissionUpdateView,TypeCreateView,TypeDeleteView,TypeUpdateView,WilayaCreateView,WilayaDeleteView,WilayaUpdateView,CommuneCreateView,CommuneDeleteView,CommuneUpdateView,MakeListView,ModelListView,TypeListView,EnergyListView,OptionListView,WilayaListView,CommuneListView,TransmissionListView
urlpatterns = [
    ...
    path('make/list', MakeListView.as_view(), name='make-change'),
    ...
    path('model/list', ModelListView.as_view(), name='model-change'),
    ...
    path('option/list', OptionListView.as_view(), name='option-change'),
    ...
    path('transmission/list', TransmissionListView.as_view(), name='transmission-change'),
    ...
    path('type/list', TypeListView.as_view(), name='type-change'),
    ...
    path('energy/list', EnergyListView.as_view(), name='energy-change'),
    ...
    path('wilaya/list', WilayaListView.as_view(), name='wilaya-change'),
    ...
    path('commune/list', CommuneListView.as_view(), name='commune-change'),
]